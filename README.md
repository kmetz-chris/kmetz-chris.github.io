...
## **Device Refresh (for Shaw Ind.)** <sub> <span style="color: gray;">August 2025 - PRESENT</span> </sub>

### Goals:

Preconfigure and push required applications to all devices to minimize manual setup and ensure consistency.

Reduce time-to-productivity for new users by providing fully configured devices at first login.

Enforce security baselines, encryption, and compliance policies across all devices to protect company data.

Establish a unified platform to monitor, configure, and secure all MacBook devices from a single dashboard.

Implement SSO (Single Sign-On) to simplify user authentication, reduce password fatigue, and improve login security.

### Description:

As part of Shaw's device refresh initiative, I am assisting the deployment of Microsoft Intune to manage approximately 1000 MacBook devices. This project focuses on enabling seamless single sign-on for users, automating the deployment of required applications, and ensuring each MacBook is fully configured and ready at first login. A key responsibility of my role is to identify, document, and track bugs and common issues encountered with Intune on macOS, providing feedback to improve our deployment process and reduce recurring problems. This effort is designed to streamline onboarding, enhance security and compliance, and minimize manual IT intervention during setup.
